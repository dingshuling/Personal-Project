...
export default function ExperienceSection() {
  ...
  const experiences = [
    ...
    },
    {
      ...
      description:
        "Led data team growth from 2 to 17 members during Tubi's 10x expansion. Established scalable A/B testing framework and data democratization. Built ML models for customer behavior prediction and content optimization.",
